...
$configuration['db']	= 'crevent';		//	<- database name
...
//plugin settings
$configuration['plugins_path'] = __DIR__  .'/plugins';  //absolute path to plugins folder, e.g c:/mycode/test/plugins or /home/phpobj/public_html/plugins
