    ...
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
	  <form role="form" action="regist.php" method="post">
		...
		<div class="form-group">
                        <input type="text" name="name" id="name" class="form-control input-lg" placeholder="Nombre completo" tabindex="1">
                        <input type="hidden" name="op" value="new">
					</div>


					<div class="form-group">
						<input type="text" name="user_name" id="user_name" class="form-control input-lg" placeholder="Nombre de usuario" tabindex="2">
					</div>

			<div class="form-group">
				<input type="email" name="email" id="email" class="form-control input-lg" placeholder="Correo" tabindex="3">
			</div>
              			<div class="form-group">
				<input type="number" name="edad" id="edad" class="form-control input-lg" placeholder="Edad" tabindex="4">
			</div>
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-6">
					<div class="form-group">
						<input type="password" name="password_confirmation" id="password_confirmation" class="form-control input-lg" placeholder="Confirme la contraseña" tabindex="6">
					</div>
				</div>
			</div>
            			<div class="form-group">
				<input type="text" name="direccion" id="direccion" class="form-control input-lg" placeholder="Dirección" tabindex="7">
			</div>

            			<div class="form-group">
				<input type="text" name="ciudad" id="ciudad" class="form-control input-lg" placeholder="Ciudad" tabindex="8">
			</div>

            			<div class="form-group">
				<input type="text" name="region" id="region" class="form-control input-lg" placeholder="Región" tabindex="9">
