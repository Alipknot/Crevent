...
--
-- Servidor: localhost
-- Tiempo de generación: 11-05-2015 a las 05:12:53
...
INSERT INTO `usuario` (`ID_user`, `Em_user`, `Contra_user`, `Nombre_us`, `edad_us`, `Dirección_us`, `Ciudad_us`, `región_us`) VALUES
('Alferdo', 'nada@verda.cl', '$2a$08$514GMyVcg.qMOZLt8Ts01uu3LV0jvWLtfgEy6ZkRF8YTxl2DeL.xy', 'Nicolas Alejandro Cancino Cancino', 20, 'asd', 'asd', 'asd'),
('Alipkno', NULL, '$2a$08$4Owx/o4T0.VvI8XzIZOyN.8TSmfnQIUiezWo73zxa2v2wTczoVi4.', NULL, NULL, NULL, NULL, NULL),
('Alipknoset', NULL, '$2a$08$jxDnyBiOSGNAosMQJIyu5OxfnVh0Z4pZyIJIySxwG8G1Lst3aGYa2', NULL, NULL, NULL, NULL, NULL),
('Alipknot', NULL, '$2a$08$MKZ4Npt.qJvO/0aqo2zFyOAwbKuTJoEEOQVpRkWUIRdx5xAiH971S', NULL, NULL, NULL, NULL, NULL),
('Alipknots', NULL, '$2a$08$yODHMA5NbrPv.0ditcuNWuPvPECHqC4Rkb3znkL6p.WMAzq0TBTyW', NULL, NULL, NULL, NULL, NULL),
('Alipksem', NULL, '$2a$08$4aGUwDASJ4I72wOtfzOGkeiVKhGkgiIEXUR7YmO/Gv3T.GGJ2RfEy', NULL, NULL, NULL, NULL, NULL),
('arbertosu', 'abldam@asds.cl', '$2a$08$mtub4LTav2.Hn2mo3YZ1tOgEoLqy0djU5kWuTJw0CW4TY1kJHQKM2', 'Ar', 32, 'sada', 'fdgfdg', 'gfdgd'),
('sdasd', 'fdssfs@fsdf.cl', '$2a$08$qXSqRxuTpUTJcLhDNP0wyOHBACdDyqtk1h6iDCxPKlE4ij/huxRiS', 'dsadas', 32, 'sada', 'fdgfdg', 'gfdgd'),
('sdasds', 'fdssfs@fsddf.cl', '$2a$08$E.5ko0yCRN/frPc/nFkxYeMsZQSHqf6tbln1LQFz1QhIKxSedQiju', 'dsadasa', 32, 'sada', 'fdgfdg', 'gfdgd'),
('yo', 'sada@salsa.com', '$2a$08$d2EdGCwosM1XGbkKPheo7uqf9k.VmQ7KmhM17f0f6SYEH2vL75YRm', 'asda', 23, 'asd', 'asd', 'asd');
...
--
ALTER TABLE `search`
  MODIFY `searchid` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=14;
--
